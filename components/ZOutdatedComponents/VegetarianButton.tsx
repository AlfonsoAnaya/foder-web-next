...
function VegetarianButton() {
    return (
        <div className="absolute md:fixed flex flex-col items-center justify-center top-[80px] right-[50px] md:top-[100px] md:right-[30px] z-[1] md:z-[11]">
