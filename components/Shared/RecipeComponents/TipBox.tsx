...
function TipBox({ recipe }: TipBoxProps) {
    return (
        <div className="w-full bg-[#24837b49] bg-opacity leading-10 p-6 mb-10 md:mb-0 rounded-lg flex flex-col md:flex-row justify-center items-center gap-4 text-dark">
