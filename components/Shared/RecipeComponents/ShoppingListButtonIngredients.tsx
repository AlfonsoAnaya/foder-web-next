function ShoppingListButtonIngredients() {
    return (
        <button className="self-center md:self-start flex gap-4  group rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-[22px] h-[22px] fill-dark group-hover:fill-gray-700" viewBox="0 0 24 24">
                ...
                <span className="btn-text group-hover:text-gray-700">Lista de compras</span>
        </button>
    )
}
