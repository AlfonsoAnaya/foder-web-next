...
function LandingComponent() {
    return (
        <div className="flex md:h-landingHeightDesktop flex-col justify-center items-center bg-grayLight md:bg-white">
            <div className="flex flex-col h-[78vh] md:h-[85%] md:flex-row border-[1px] border-dark border-dashed bg-tertiary rounded-xl
                ...
                <div className="w-[100%] md:w-[45%] h-[70%] md:h-[100%] flex flex-wrap justify-center items-center">
                    ...
                    <Image 
                        className="block object-cover w-[100%] h-[100%] object-center md:rounded-[11px] border-l-[1px] border-dark border-dashed"
