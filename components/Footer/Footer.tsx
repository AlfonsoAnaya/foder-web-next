        ...
        <footer className="w-100% h-[150px] mt-[100px] flex flex-col md:flex-row gap-2 md:gap-10 justify-center items-start md:items-center p-6 bg-dark text-white">
            ...
            <div className="social-media">
                <Link href="https://instagram.com/somospipian">
                        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" className="fill-[#fffcfb] hover:fill-secondary" >
            ...
            <div className="font-siteTitle footer-links flex flex-col md:flex-row gap-2 md:gap-6">
                <Link href="https://pipian.vercel.app/" className="contact hover:text-secondary underline">Contacto</Link>
                <Link href="https://pipian.vercel.app/" className="terms-of-use hover:text-secondary underline">Términos y Condiciones</Link>
                <Link href="https://pipian.vercel.app/" className="privacy-policy hover:text-secondary underline">Política de Privacidad</Link>
            </div>
