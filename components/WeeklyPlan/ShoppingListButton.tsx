...
function ShoppingListButton() {
    return (
        <div className="absolute btn-toggle md:fixed flex flex-col items-center justify-center top-[78px] right-[20px] md:top-[170px] md:right-[20px] z-[1] md:z-[11]">
            <div className="bg-secondary btn-container border-[1px] hover:cursor-pointer border-secondary rounded-full p-2 ">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-[25px] h-[25px] fill-white" viewBox="0 0 24 24">
