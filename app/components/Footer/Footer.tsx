    ...
    return (
        <footer className="w-100% h-[200px] mt-10 flex flex-col md:flex-row gap-2 md:gap-10 justify-center items-start md:items-center p-6 bg-primary text-white">
            ...
            <div className="social-media">
                <a href="https://somospipian.netlify.app/">
            ...
            <div className="footer-links flex flex-col md:flex-row gap-2 md:gap-6">
                <a href="https://somospipian.netlify.app/" className="contact hover:text-dark underline">Contacto</a>
                <a href="https://somospipian.netlify.app/" className="terms-of-use hover:text-dark underline">Términos y Condiciones</a>
                <a href="https://somospipian.netlify.app/" className="privacy-policy hover:text-dark underline">Política de Privacidad</a>
            </div>
